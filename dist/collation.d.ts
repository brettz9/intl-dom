...
export function sortList(locale: string, arrayOfItems: string[], map: ((str: string, idx: Integer) => any) | Intl.ListFormatOptions | undefined, listOptions?: Intl.ListFormatOptions | undefined, collationOptions?: Intl.CollatorOptions | undefined): DocumentFragment | string;
